...
describe Currency do
  ...
  it "Converts to base currency to 5 decimal places" do
    @currency.rate = 2.5
    @currency.convert_to_base(100).should eq(40)
    @currency.rate = 0.3
    @currency.convert_to_base(10).should eq(33.33333)
  end

  it "Converts from base to 5 decimal places" do
    @currency.rate = 2.5
    @currency.convert_from_base(250).should eq(625)
    @currency.rate = 0.3
    @currency.convert_from_base(10).should eq(3)
  end
end
